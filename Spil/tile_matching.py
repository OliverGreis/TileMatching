...
effects = []
# tile vars
tile_colors = [(0,0,0), (255,0,0), (0,255,0), (0,0,255), (255,255,0), (0,255,255),(255,255,255)]
tile_offset = [280,530]
tile_size = [50,50]
...
bombe_img = pygame.image.load('bomb64.png')
pygame.mixer.init()
...
bombe_button = Button(100,100,bombe_img,0.45)
